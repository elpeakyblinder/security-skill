...
- **AI chatbot and transactional workflow (Astro/TypeScript/Groq/Resend):** [AI chatbot case study](examples/case-study-ai-chatbot.md) · [Caso de estudio: chatbot con IA (es)](examples/caso-estudio-chatbot-ia.md).
