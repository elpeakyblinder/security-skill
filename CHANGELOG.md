...
- Caso de estudio real de autenticación y control de roles en aplicación de escritorio (`examples/caso-estudio-autenticacion-pos.md` y `examples/case-study-pos-authentication.md`), documentando la auditoría y blindaje de cuentas inactivas, timing attacks, DoS y enumeración en Python/PyQt6 con SQLite y MySQL.
...
English summary: added practical validation case studies (multi-tenant Laravel shift rotations and Python/PyQt6 desktop POS authentication/authorization), documenting real vulnerabilities remediated with an AI agent, plus an automated Node.js suite for repository packaging and consistency.
